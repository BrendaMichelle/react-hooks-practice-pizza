...
function PizzaForm({ selectedPizza, onInputChange, onSubmit }) {

  function handleRadioChange(e) {
    onInputChange(e.target.name, e.target.value === "Vegetarian")
  }
  ...
  const { id, vegetarian, size, topping } = selectedPizza;
